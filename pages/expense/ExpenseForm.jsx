                        ...
                        <div className="relative bg-white p-8 md:p-1 rounded-lg dark:border-strokedark dark:bg-boxdark w-full max-w-xl max-h-full">
                            ...
                            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                                    {setEditData?._id ? "Update expense" : "Create New expense"}
                                </h3>
                                <button
                                    onClick={() => {
                                        onClose();
                            ...
                            <form onSubmit={handleSubmit} className="p-4 md:p-5">
                                ...
                                <div className="w-full sm:w-1/2">
                                            ...
                                            <input
                                                ...
                                                // onChange={handleChange}
                                                // defaultValue={expense?.date ? formatDate(expense.date) : ''}
                                                // value={expense?.date ? formatDate(expense.date) : ''}
                                ...
                                <div className="ml-auto">
                                    ...
                                    >
                                        ...
                                        {expense?.id ? "Update expense" : "Create New expense"}
